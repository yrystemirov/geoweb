  ...
  kk: {
    translation: {
      ...
      attrs: {
        ...
        shortInfo: 'Қысқа ақпаратта көрсету',
        fullInfo: 'Толық ақпаратта көрсету',
      },
      yes: 'Ия',
      no: 'Жоқ',
      success: 'Сәтті',
  ...
  ru: {
    translation: {
      ...
      attrs: {
        ...
        shortInfo: 'Отображать в краткой информации',
        fullInfo: 'Отображать в полной информации',
      },
      yes: 'Да',
      no: 'Нет',
      success: 'Успешно',
