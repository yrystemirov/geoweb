...
const resources = {
  kk: {
    translation: {
      ...
      myLocationError: 'Орын іздеу кезінде қате пайда болды',
      ...
      editPermissions: 'Рұқсаттарды өңдеу',
      cancel: 'Бас тарту',
      close: 'Жабу',
      confirm: 'Растау',
      delete: 'Жою',
      ...
      unsupportedSymbols: 'Жарамсыз символдар: {{symbols}}',
      ...
      styleRules: {
        ...
        iconType: {
          title: 'Белгіше түрі',
          shape: 'Түрлі-түсті фигура',
          file: 'Жүктелген файл',
        },
        addIcon: 'Сүрет қосу',
        changeIcon: 'Сүретті ауыстыру',
        imgSrc: 'Суреттің жолы',
        imgFormat: 'Пішімі',
      ...
      layerPanel: {
        openAttrTable: 'Атрибуттық кесте',
        attrTableIsOpen: ' (ашылған)',
        filter: 'Сүзгі',
        setOpacity: 'Қабаттың түсірілімін орнату',
        showLegend: 'Легенданы көрсету',
        hideLegend: 'Легенданы жасыру',
        legendIsUnavailable: 'Легенда қол жетімсіз',
        zoomToLayer: 'Қабатқа жақындау',
      },
      access: {
        title: 'Рұқсаттар',
        LAYER: '{{name}} Қабаттың рұқсаттары',
        FOLDER: '{{name}} Буманың рұқсаттары',
        MAP: '{{name}} Картаның рұқсаттары',
        noAccess: 'Рұқсат барлығына жабық',
        role: 'Рөл',
        read: 'Оқу',
        write: 'Жазу',
      },
      cqlFilter: {
        title: '{{name}} Қабаттың фильтрі',
        add: 'Фильтр қосу',
        delete: 'Фильтрді жою',
        attr: 'Фильтрленетін қабат атрибуты',
        operator: 'Салыстыру операторы',
        value: 'Мән',
        dateValue: 'Күн мәні',
        disclaimer: 'Бір атрибутқа тек бір фильтр қолданылады',
        operators: {
          '=': 'Тең',
          '<>': 'Тең емес',
          '>': 'Үлкен',
      ...
      'file.with_name.already_exists': 'Осы атаумен файл бар',
      forbidden: 'Құқықсыз',
    },
  },
  ru: {
    translation: {
      ...
      myLocationError: 'Произошла ошибка при поиске местоположения',
      ...
      editPermissions: 'Редактировать доступ',
      cancel: 'Отмена',
      close: 'Закрыть',
      confirm: 'Подтвердить',
      delete: 'Удалить',
      ...
      unsupportedSymbols: 'Недопустимые символы: {{symbols}}',
      ...
      styleRules: {
        ...
        iconType: {
          title: 'Тип иконки',
          shape: 'Цветная фигура',
          file: 'Загруженный файл',
        },
        addIcon: 'Добавить изображение',
        changeIcon: 'Заменить изображение',
      ...
      layerPanel: {
        openAttrTable: 'Атрибутивная таблица',
        attrTableIsOpen: ' (открыта)',
        filter: 'Фильтр',
        setOpacity: 'Прозрачность',
        showLegend: 'Отобразить легенду',
        hideLegend: 'Скрыть легенду',
        legendIsUnavailable: 'Легенда недоступна',
        zoomToLayer: 'Приблизить к слою',
      },
      access: {
        title: 'Доступ',
        LAYER: 'Доступ к слою {{name}}',
        FOLDER: 'Доступ к папке {{name}}',
        MAP: 'Доступ к карте {{name}}',
        noAccess: 'Доступ закрыт для всех',
        role: 'Роль',
        read: 'Чтение',
        write: 'Запись',
      },
      cqlFilter: {
        title: 'Фильтр слоя {{name}}',
        add: 'Добавить фильтр',
        ...
        value: 'Значение',
        dateValue: 'Значение даты',
        disclaimer: 'На один атрибут доступен лишь один фильтр',
        operators: {
          '=': 'Равно',
          '<>': 'Не равно',
          '>': 'Больше',
      ...
      'file.with_name.already_exists': 'Файл с таким именем уже существует',
      forbidden: 'Запрещено',
    },
  },
};
