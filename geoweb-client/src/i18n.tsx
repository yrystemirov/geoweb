  ...
  kk: {
    translation: {
      ...
      maps: {
        ...
        deleteLayerAtAll: 'Қабатты толық жою',
        deleteLayerHere: 'Қабатты осында жою',
        deleteLayerFromAll: 'Қабатты барлығынан жою',
  ...
  ru: {
    translation: {
      ...
      maps: {
        ...
        deleteLayerAtAll: 'Удалить слой безвозвратно',
        deleteLayerHere: 'Удалить слой отсюда',
        deleteLayerFromAll: 'Удалить слой везде',
